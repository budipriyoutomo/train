...
class Evaluasi extends MY_Controller {
    ...
    public function read($id)
    {
		...
		'evaluasi' => $row->evaluasi,
			...
			$this->load->view('header');
            $this->load->view('evaluasi/ttraining_read', $data);
            $this->load->view('footer');
        } else {
    ...
    public function create()
    {
		...
		$this->load->view('header');
		$this->load->view('evaluasi/evaluasi_form', $data);
    $this->load->view('footer');
  ...
  $row = $this->Mtraining_model->get_by_id($id);
	...
	public function evcontrol($id){

		header('Content-Type: application/json');
		$data = $this->Ttraining_model->ttrain($id);
  ...
  public function editnilai($id)
  {
    ...
    if ($row) {
        $data = array(
            'button' => 'Update',
            'action' => site_url('evaluasi/update_nilai'),
  ...
  public function update_nilai()
  {
    ...
    public function word()
    {
        ...
        $this->load->view('evaluasi/ttraining_doc',$data);
    }
